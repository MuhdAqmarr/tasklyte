            ...
            <div class="row">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_border">
                                                        ...
                                                        <span
                                                            class="badge badge-pill badge-{{ \App\Models\Project::$status_color[$project->status] }}">{{ __(\App\Models\Project::$status[$project->status]) }}</span>
                                                    </td>
                                                </tr>
                                                <tr role="row">
                                            ...
                                            <tbody>
                                                @foreach ($project->milestones as $key => $milestone)
                                                    <tr>
                                                        ...
                                                        <td> <span
                                                                class="badge badge-pill badge-{{ \App\Models\Project::$status_color[$milestone->status] }}">{{ __(\App\Models\Project::$status[$milestone->status]) }}</span>
                                                        </td>
                ...
                <div class="mt-3 mb-3 row d-flex align-items-center justify-content-end ml-2 col-12" id="show_filter">
                    ...
                    <button class="btn btn-white btn-sm  col-auto btn-filter apply" style="border: 1px solid #E0E6ED;"
                        id="filter"><i class="mdi mdi-check"></i>{{ __('Apply') }}</button>

                    <button class=" btn btn-white btn-sm  col-auto " style="border: 1px solid #E0E6ED;"> <a
                            href="{{ route('project_report.export', $project->id) }}" class="btn-white">
