...
@section('role')
    {{ __('You are ') . __(ucfirst($project->permission())) }}
@endsection
                        ...
                        <div class="row">
                            ...
                            <div class="col-auto">
                                <div class="progress-circle progress-sm"
                                    ...
                                    data-text="{{ $project_data['task']['percentage'] }}%" data-color="primary"></div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <span
                                    class="h4 font-weight-bold mb-0 ">{{ \App\Models\Utility::projectCurrencyFormat($project->id, $project_data['expense']['total']) }}</span>
                            </div>
                            <div class="col-auto">
                                <div class="progress-circle progress-sm"
                                    data-progress="{{ $project_data['expense']['percentage'] }}"
                                    data-text="{{ $project_data['expense']['percentage'] }}%" data-color="primary"></div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <span
                                    class="text-sm text-muted">{{ __('Total Budget') . ' : ' . \App\Models\Utility::projectCurrencyFormat($project->id, $project_data['expense']['allocated']) }}</span>
                            </div>
                        </div>
                    </div>
                </div> -->
                    ...
                    <div class="pb-3 mb-3 border-bottom">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                ...
                                @if ($project->image)
                                    <img src="{{ $logo_path . $project->image }}" alt="{{ $project->title }}"
                                        class="avatar rounded-circle" id="blah" title="{{ $project->title }}" />
                                @else
                                    <img {{ $project->img_image }} class="avatar rounded-circle" title="{{ $project->title }}">
                                @endif
                        ...
                        <li class="list-group-item">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    ...
                                    <div class="h6 mb-0">{{ \App\Models\Utility::getDateFormated($project->start_date) }}
                                    </div>
                                </div>
                                <div class="col-6">
                            ...
                            <div class="col-auto">
                                <div class="actions">
                                    <a href="#" class="action-item"
                                        ...
                                        data-ajax-popup="true" data-size="lg" data-title="{{ __('Add Member') }}">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        @if (isset($permissions) && in_array('create milestone', $permissions))
                            <div class="text-right">
                                <a href="#" data-url="{{ route('project.milestone', $project->id) }}"
                                    data-ajax-popup="true" data-title="{{ __('Create New Milestone') }}"
                                    class="action-item">
                                    <i class="fas fa-plus"></i>
                                    <span class="d-sm-inline-block">{{ __('Add') }}</span>
                                </a>
                                        ...
                                        <div class="media-body text-right">
                                            ...
                                            @if (in_array('delete milestone', $permissions))
                                                <span class="text-sm ml-3 text-danger" data-toggle="tooltip"
                                                    ...
                                                    data-confirm-yes="document.getElementById('delete-form-{{ $milestone->id }}').submit();">
                                    ...
                                    <div class="px-3 py-3">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-auto actions">
                                                ...
                                                <a href="{{ $logo . $attachment->file }}" download class="action-item"
                                                    role="button">
            ...
            $(document).on('click', '.check-invite-members', function(e) {
                ...
                if (email == '') {
                    emailele.focus().after(
                        '<small class="email-error-message text-danger">{{ __('This field is required.') }}</small>'
                        );
                    return false;
                }
                ...
                if (!emailReg.test(email)) {
                    emailele.focus().after(
                        '<small class="email-error-message text-danger">{{ __('Please enter valid email address.') }}</small>'
                        );
                    return false;
                } else {
            ...
            $(document).on('click', '.invite-members', function() {
                ...
                if (username == '') {
                    $('#username').focus().after(
                        '<small class="username-error-message text-danger">{{ __('This field is required.') }}</small>'
                        );
                    return false;
                }
                ...
                if (userpassword == '') {
                    $('#userpassword').focus().after(
                        '<small class="userpassword-error-message text-danger">{{ __('This field is required.') }}</small>'
                        );
                    return false;
                }
