            ...
            <div class="col-lg-4">
                <div class="card card-fluid">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center">
                            <div class="col">
                                <h6 class="text-sm mb-0">{{__('Total Completed Subtask')}}</h6>
                        ...
                        <div class="row align-items-center">
                            <div class="col">
                                <h6 class="text-sm mb-0">{{__('Total Open Subtask')}}</h6>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="mb-0">{{__('My Subtasks')}}</h6>
                        </div>
                    </div>
                </div>
    ...
    @if($role['role'] != 'Client')
        <div class="row">
            <div class="col-lg-4">
                <div class="card card-fluid">
                    <div class="card-header">
                        <h6 class="mb-0">{{__('Total Subtasks Report')}}</h6>
                    </div>
                    <div class="card-body">
                                            ...
                                            <div class="px-3 py-3">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-auto actions">
                                                        <a href="{{$logo.$task_file->file}}" download class="action-item" role="button">
