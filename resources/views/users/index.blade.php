...
@section('action-button')
    ...
    <div class="dropdown btn btn-sm btn-white btn-icon-only rounded-circle ml-2 m-0 mb-1">
    ...
    @if($allow == true)
        <a href="#" class="btn btn-sm btn-white btn-icon-only rounded-circle ml-2 m-0 mb-1" data-url="{{ route('add.user.view') }}" data-ajax-popup="true" data-size="lg" data-title="{{__('Add Member')}}">
    ...
    @endif
<a href="{{ route('logindetails.index') }}" class="btn btn-sm btn-white btn-icon-only rounded-circle ml-2 m-0 mb-1" data-bs-toggle="tooltip" title="{{ __('User Log') }}">
        <i class="fas fa-history"></i>
    </a>
    <a href="{{route('members.export')}}" class="btn btn-sm btn-white btn-icon-only rounded-circle ml-2 mb-1" data-title="{{__('Export Members CSV file')}}" data-toggle="tooltip">
        <i class="fa fa-file-excel"></i>
    </a>

    <a href="#" class="btn btn-sm btn-white btn-icon-only rounded-circle mb-1" data-url="{{ route('members.file.import') }}" data-ajax-popup="true" data-title="{{__('Import Members CSV file')}}" data-toggle="tooltip">
