...
<?php
    $profile_img  =\App\Models\Utility::get_file(config('chatify.user_avatar.folder'));    
?>
              ...
              <form id="update-settings" action="<?php echo e(route('avatar.update')); ?>" enctype="multipart/form-data" method="POST">
                  ...
                  <div class="app-modal-body">
                        ...
                        <?php if(!empty(Auth::user()->avatar)): ?>
                            <div class="avatar av-l upload-avatar-preview chatify-d-flex" style="background-image: url('<?php echo e($profile_img.'/'.Auth::user()->avatar); ?>');">
                            </div>
                        <?php else: ?>
                            <div class="avatar av-l upload-avatar-preview chatify-d-flex" style="background-image: url('<?php echo e($profile_img.'/avatars/avatar.png'); ?>');">
                            </div>
                        <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\Tasklyte\resources\views/vendor/Chatify/layouts/modals.blade.php ENDPATH**/ ?>