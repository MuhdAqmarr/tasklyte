...
<?php $__env->startSection('action-button'); ?>
    <div class="col-md-12 d-flex align-items-center gap-2 flex-wrap justify-content-md-end">
        <?php if(isset($permissions) && in_array('project setting', $permissions)): ?>
            ...
            data-toggle="tooltip" data-original-title="<?php echo e(__('Task Settings')); ?>">
        ...
        <a href="<?php echo e(route('projects.tasks.index', $project->id)); ?>" class="btn btn-sm bg-white btn-icon rounded-pill ml-0">
            <span class="btn-inner--text text-dark"><?php echo e(__('Subtasks')); ?></span>
        </a>
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="card card-stats border-0">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <h6 class="text-muted mb-1"><?php echo e(__('Subtask Done')); ?></h6>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <span
                                    class="text-sm text-muted"><?php echo e(__('Total Subtask') . ' : ' . $project_data['task']['total']); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <span class="text-sm text-muted"><?php echo e(__('Last 7 days subtask done')); ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="progress-wrapper">
                            <small class="progress-label"><?php echo e(__('Open Subtask')); ?> <span
            ...
            <div class="col-xl-3 col-sm-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="progress-wrapper mb-3">
                            <small class="progress-label"><?php echo e(__('Total task time spent')); ?> <span
                        ...
                        <div class="progress-wrapper">
                            <small class="progress-label"><?php echo e(__('Allocated hours on subtask')); ?> <span
            ...
            <div class="col-xl-3 col-sm-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="progress-wrapper">
                            <small class="progress-label"><?php echo e(__('Allocated hours')); ?> <span
                                    class="text-muted"><?php echo e($project_data['task_allocated_hrs']['hrs']); ?></span></small>
                            <div class="progress mt-0 height-3">
                                <div class="progress-bar bg-warning" role="progressbar"
                                    aria-valuenow="<?php echo e($project_data['task_allocated_hrs']['percentage']); ?>"
        ...
        <div class="col-sm-6">
            <div class="card card-fluid">
                <div class="card-header">
                    <h6 class="mb-0"><?php echo e(__('Task overview')); ?></h6>
                </div>
                                    ...
                                    <div class="media align-items-center">
                                        <div class="media-body">
                                            <h6 class="text-sm d-block text-limit mb-0"><?php echo e($milestone->title); ?>
                                                ...
                                                <span
                                                    class=" mx-3 badge badge-pill badge-<?php echo e(\App\Models\Project::$status_color[$milestone->status]); ?>"><?php echo e(__(\App\Models\Project::$status[$milestone->status])); ?>

                                                </span><?php echo e($milestone->tasks->count() . ' ' . __('Subtasks')); ?>
                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <?php if(\Auth::user()->checkProject($project->id) == 'Owner'): ?>
                                <small><?php echo e(__('Attachment that uploaded in this task')); ?></small>
                            <?php else: ?>
                                <small><?php echo e(__('Attachment that uploaded in your assigned subtasks')); ?></small>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <?php if(\Auth::user()->checkProject($project->id) == 'Owner'): ?>
                                    <small><?php echo e(__('Activity Log of this task')); ?></small>
                                <?php else: ?>
                                    <small><?php echo e(__('Activity Log of your assigned subtasks')); ?></small>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tasklyte\resources\views/projects/show.blade.php ENDPATH**/ ?>