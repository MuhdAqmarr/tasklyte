...
<nav class="navbar navbar-main navbar-expand-lg navbar-dark bg-gradient-dark navbar-border py-3" id="navbar-main">
    <div class="container px-lg-0">
        ...
        <a class="navbar-brand mr-lg-5" href="<?php echo e(url('home')); ?>">
            <img src="<?php echo e($logo.'logo.png'.'?'.time()); ?>" id="navbar-logo" style="height: 40px; width:163px;">
        </a>
            ...
            <div class="row pt-md">
                <div class="col-lg-4 mb-5 mb-lg-0">
                    <a href="<?php echo e(url('home')); ?>">
                        <img src="<?php echo e($logo.'logo.png'.'?'.time()); ?>" id="navbar-logo" style="height: 25px;">
                    </a>
...
<?php /**PATH C:\xampp\htdocs\Tasklyte\resources\views/layouts/landing.blade.php ENDPATH**/ ?>