...
<div class="sidenav-header d-flex align-items-center">
    <a class="navbar-brand" href="#">
        ...
        <img src="<?php echo e($logo.'/logo/logo.png'.'?'.time()); ?>" class="navbar-brand-img" alt="..." style="height: 40px; width:163px;">
...
<div class="nav-application clearfix">
    ...
    <?php if(\Auth::user()->type == 'admin'): ?>
        ...
        <a href="<?php echo e(route('email_template.index')); ?>" class="btn btn-square text-sm <?php echo e(request()->is('email_template*') || request()->is('mail_template_lang*') ? 'active' : ''); ?>">
