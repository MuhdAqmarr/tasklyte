    ...
    <?php echo e(Form::open(['route' => ['logindetails.index'], 'method' => 'get', 'id' => 'userlogs_filter'])); ?>
            ...
            <div class="d-flex align-items-center justify-content-end">
                <div class="col-xl-4 col-lg-3 col-md-6 col-sm-12 col-12">
                    <div class="btn-box">
                        <?php echo e(Form::month('month',isset($_GET['month'])?$_GET['month']: '',array('class'=>'form-control'))); ?>
            ...
            <table class="table align-items-center" id="myTable">
                ...
                <tbody>
                    ...
                    <tr class="font-style">
                        ...
                        <td><?php echo e($details->device_type); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tasklyte\resources\views/users/login_details.blade.php ENDPATH**/ ?>