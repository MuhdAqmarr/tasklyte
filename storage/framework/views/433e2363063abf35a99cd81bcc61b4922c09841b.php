                    ...
                    <div class="row">
                        ...
                        <div class="col text-right pt-1">
                            <div class="custom-control custom-checkbox timesheet-owner">
                                <input type="checkbox" class="custom-control-input owner-timesheet-status" checked id="owner-check">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tasklyte\resources\views/projects/timesheet_list.blade.php ENDPATH**/ ?>