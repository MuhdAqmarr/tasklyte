    ...
    <div class="row">
        <div class="col-12 col-md-12">
            <div class="text-right">
                <a href="#" class="btn btn-sm btn-primary rounded-pill ml-2" data-url="<?php echo e(route('generate',['plan'])); ?>" data-ajax-popup-over="true" data-bs-placement="top" data-size="md" title="<?php echo e(__('Generate')); ?>" data-title="<?php echo e(__('Generate content with AI')); ?>">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            <div class="form-group">
                ...
                <input type="number" min="0" class="form-control" id="trial_days" name="trial_days" required/>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="number" min="-100" class="form-control" id="storage_limit" name="storage_limit" required/>
                    <div class="input-group-prepend">
...
<?php /**PATH C:\xampp\htdocs\Tasklyte\resources\views/plans/create.blade.php ENDPATH**/ ?>