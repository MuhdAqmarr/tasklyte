...
<div class="row">
    ...
    <div class="col-8">
        <div class="form-group">
            <?php echo e(Form::label('title', __('Subtask name'),['class' => 'form-control-label'])); ?>
    ...
    <div class="col-12">
        <div class="form-group">
            ...
            <?php echo e(Form::textarea('description', null, ['class' => 'form-control','rows'=>'3','data-toggle' => 'autosize'])); ?>
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            <small class="form-text text-muted mb-2 mt-0"><?php echo e(__('Total hrs of task ').$hrs['total'].__(' & allocated total ').$hrs['allocated'].__(' hrs in other subtask')); ?></small>
...
<div class="form-group">
    ...
    <small class="form-text text-muted mb-2 mt-0"><?php echo e(__('Below members are assigned in your task.')); ?></small>
</div>
...
<?php /**PATH C:\xampp\htdocs\Tasklyte\resources\views/tasks/edit.blade.php ENDPATH**/ ?>