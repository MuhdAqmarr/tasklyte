        ...
        <li class="nav-item dropdown ">
            <a class="" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="h6 text-sm mb-0 text-white"><i class="fas fa-globe-asia"></i>
                    <?php echo e(ucfirst($languages[$currEmailTempLang->lang])); ?></span>
            ...
            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code =>$lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('manage.email.language', [$emailTemplate->id, $code])); ?>"
                        class="dropdown-item <?php echo e($currEmailTempLang->lang == $lang ? 'text-danger' : ''); ?>"><?php echo e(ucfirst($lang)); ?></a>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 language-form-wrap">
                                ...
                                <div class="col-12 col-md-12">
                                    <div class="text-right">
                                        ...
                                        <a href="#" class="btn btn-sm btn-primary rounded-pill m-3" data-url="<?php echo e(route('generate',['email_template'])); ?>" data-ajax-popup-over="true" data-bs-placement="top" data-size="md" title="<?php echo e(__('Generate')); ?>" data-title="<?php echo e(__('Generate content with AI')); ?>">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <?php $__currentLoopData = explode(',', $emailTemplate->keyword); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyword): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <p class="col-4"><?php echo e(__($word[0])); ?> : <span
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tasklyte\resources\views/email_templates/show.blade.php ENDPATH**/ ?>