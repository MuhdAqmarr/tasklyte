            ...
            <div class="col-lg-4">
                <div class="card card-fluid">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center">
                            <div class="col">
                                <h6 class="text-sm mb-0"><?php echo e(__('Total Completed Subtask')); ?></h6>
                        ...
                        <div class="row align-items-center">
                            <div class="col">
                                <h6 class="text-sm mb-0"><?php echo e(__('Total Open Subtask')); ?></h6>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="mb-0"><?php echo e(__('My Subtasks')); ?></h6>
                        </div>
                    </div>
                </div>
    ...
    <?php if($role['role'] != 'Client'): ?>
        <div class="row">
            <div class="col-lg-4">
                <div class="card card-fluid">
                    <div class="card-header">
                        <h6 class="mb-0"><?php echo e(__('Total Subtasks Report')); ?></h6>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <small class="text-muted"><?php echo e(__('That uploaded for this user\'s assigned project')); ?></small>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tasklyte\resources\views/users/info.blade.php ENDPATH**/ ?>