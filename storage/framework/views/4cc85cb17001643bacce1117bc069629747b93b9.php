                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
                                                                ...
                                                                <tr>
                                                                    <td style="width:110px;">
                                                                        <img alt="" height="auto" src="<?php echo e($logo . '/' . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo.png'.'?'.time())); ?>" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;" title="" width="110"/>
                                                                    </td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                                            <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                ...
                                                                <p style="margin: 10px 0;"><i style="font-style:normal"><b style="font-weight:700"><?php echo e((isset(\App\Models\Utility::settings()['company_name']) && !empty(\App\Models\Utility::settings()['company_name']))?\App\Models\Utility::settings()['company_name']:env('APP_NAME')); ?></b></i></p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
...
<?php /**PATH C:\xampp\htdocs\Tasklyte\resources\views/email/test.blade.php ENDPATH**/ ?>