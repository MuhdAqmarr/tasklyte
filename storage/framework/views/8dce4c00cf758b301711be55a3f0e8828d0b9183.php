                                        ...
                                        <table class="table" id="pc-dt-simple">
                                            <tbody>
                                                <tr class="table_border">
                                                    <th class="table_border"><?php echo e(__('Task Name')); ?>:</th>
                                                    <td class="table_border"><?php echo e($project->title); ?></td>
                                                </tr>
                                                <tr>
                                                    <th class="table_border"><?php echo e(__('Task Status')); ?>:</th>
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <h6><?php echo e(__('Subtask Priority')); ?></h6>
                            </div>
                    ...
                    <div class="col-md-5">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <h6><?php echo e(__('Subtask Status')); ?></h6>
                            </div>
                            <div class="card-body" style="height: 285px !important;">
                                <div class="row align-items-center">
                                    <div class="col-12">
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo e(__('Assigned Subtasks')); ?></th>
                                                <th><?php echo e(__('Done Subtasks')); ?></th>
                ...
                <div class="mt-3 mb-3 row d-flex align-items-center justify-content-end ml-2 col-12" id="show_filter">
                    <div class="col-auto ">
                        <select class="form-control form-control-sm w-auto" name="all_users" id="all_users">
                            <option value="" class="px-4"><?php echo e(__('All Members')); ?></option>
                            ...
                            <div class="row">
                                ...
                                <div class="table-responsive"
                                    ...
                                    <table class="table" id="tasks-selection-datatable">
                                        <thead>
                                            <th><?php echo e(__('Subtasks Name')); ?></th>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tasklyte\resources\views/project_report/show.blade.php ENDPATH**/ ?>