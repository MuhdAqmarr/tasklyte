                            ...
                            <ul class="nav justify-content-center justify-content-md-end">
                                <li class="nav-item dropdown border-right">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                        ...
                                        <a href="<?php echo e(route('lang.change', $code)); ?>"
                                                class="dropdown-item <?php echo e($code == $a_lang ? 'active' : ''); ?> "><?php echo e(ucFirst($lang)); ?></a>
...
<?php /**PATH C:\xampp\htdocs\Tasklyte\resources\views/layouts/admin.blade.php ENDPATH**/ ?>