    ...
    <div class="row">
                ...
                <div class="list-group list-group-flush" id="tabs">
                    ...
                    <div data-href="#tabs-2" class="list-group-item">
                        <div class="media">
                            ...
                            <div class="media-body ml-3">
                                ...
                                <p class="mb-0 text-sm"><?php echo e(__('Likes estimated hours.')); ?></p>
                            </div>
                        </div>
                    </div>
                    <div data-href="#tabs-3" class="list-group-item">
                        <div class="media">
                            ...
                            <div class="media-body ml-3">
                                <a href="#" class="stretched-link h6 mb-1"><?php echo e(__('Subtask Stage')); ?></a>
                                <p class="mb-0 text-sm"><?php echo e(__('System will consider last stage as a completed / done subtask for get progress on task.')); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div data-href="#tabs-5" class="list-group-item">
                        <div class="media">
                            ...
                            <div class="media-body ml-3">
                                <a href="#" class="stretched-link h6 mb-1"><?php echo e(__('Shared Task Settings')); ?></a>
                                <p class="mb-0 text-sm"><?php echo e(__('Shared Task Settings.')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-8 order-lg-1">
            <div id="tabs-1" class="tabs-card">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class=" h6 mb-0"><?php echo e(__('Subtask Progress Calculation')); ?></h5>
                    </div>
                    <div class="card-body">
                        <?php echo e(Form::model($project, ['route' => ['projects.update', $project->id], 'id' => 'edit_project', 'method' => 'PUT', 'enctype'=>'multipart/form-data'])); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('currency_code', null, ['class' => 'form-control','required' => 'required'])); ?>
            ...
            <div id="tabs-5" class="tabs-card d-none">
                <div class="card">
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                        <h5 class="h6 mb-0"><?php echo e(__('Shared Task Settings')); ?></h5>
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tasklyte\resources\views/projects/edit.blade.php ENDPATH**/ ?>