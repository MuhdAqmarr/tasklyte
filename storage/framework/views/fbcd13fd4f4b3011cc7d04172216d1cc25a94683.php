                    ...
                    <div class="row">
                        ...
                        <div class="col-6" id="google_cal">
                            ...
                            onchange="get_data()">
                                    ...
                                    <option value="local_calender" selected="true">Local Calendar</option>
                                </select>
                            <?php endif; ?>
                        </div>
                        <div class="card-body">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tasklyte\resources\views/tasks/calendar.blade.php ENDPATH**/ ?>