                    ...
                    <table class="table align-items-center  mt-2" id="selection-datatable1">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="sort"> <?php echo e(__('Task Name')); ?></th>
                                <th scope="col" class="sort"> <?php echo e(__('Start Date')); ?></th>
                                <th scope="col" class="sort"> <?php echo e(__('Due Date')); ?></th>
                                <th scope="col" class="sort"> <?php echo e(__('Task Member')); ?></th>
                                <th scope="col" class="sort"> <?php echo e(__('Progress')); ?></th>
                                <th scope="col" class="sort"><?php echo e(__('Task Status')); ?></th>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tasklyte\resources\views/project_report/index.blade.php ENDPATH**/ ?>