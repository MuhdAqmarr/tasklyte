...
<div class="d-flex align-items-center  justify-content-between">
    <?php if($view == 'grid'): ?>
        <a href="<?php echo e(route('projects.list','list')); ?>" class="btn btn-sm bg-white btn-icon rounded-pill ml-2">
...
<div class="d-flex align-items-center justify-content-end mt-2 mt-md-0">
    ...
    <div class="dropdown btn btn-sm btn-white btn-icon-only rounded-circle ml-2 m-0">
        ...
        <div class="dropdown-menu dropdown-menu-right project-filter-actions dropdown-steady" id="project_status">
            ...
            <?php $__currentLoopData = \App\Models\Project::$status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tasklyte\resources\views/projects/index.blade.php ENDPATH**/ ?>