                            ...
                            <?php if($plan_requests->count() > 0): ?>
                                <?php $__currentLoopData = $plan_requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prequest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="font-weight-bold"><?php echo e($prequest->plan->max_users <= 0 ? 'Unlimited' : $prequest->plan->max_users); ?></div>
                                            <div><?php echo e(__('Users')); ?></div>
                                        </td>

                                        <td>
                                            <div class="font-weight-bold"><?php echo e($prequest->plan->max_projects <= 0 ? 'Unlimited' : $prequest->plan->max_projects); ?></div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tasklyte\resources\views/plan_request/index.blade.php ENDPATH**/ ?>