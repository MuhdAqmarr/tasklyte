    ...
    <?php else: ?>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="card card-stats">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <h6 class="text-muted mb-1"><?php echo e(__('Total Subtasks')); ?></h6>
            ...
            <div class="col-xl-12 col-md-12">
                <div class="card card-fluid">
                    <div class="card-header">
                        <h6 class="mb-0"><?php echo e(__('Subtasks Overview')); ?></h6>
                        <small class="text-muted"><?php echo e(__('Total Completed subtask in last 7 days')); ?></small>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-sm-12 col-sm-12 col-md-4 col-lg-4">
                <div class="card card-fluid">
                    <div class="card-header">
                        <h6 class="mb-0"><?php echo e(__('Tasks Status')); ?></h6>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-xl-8 col-md-8">
                <div class="card card-fluid">
                    <div class="card-header border-0">
                        <h6 class="mb-0"><?php echo e(__('Top Due Subtasks')); ?></h6>
                    </div>
                    <div class="card-wrapper table_scroll p-3">
                        <div class="table-responsive" style="position: relative;">
                            <table class="table align-items-center">
                                <thead>
                                <tr>
                                    <th scope="col" class="sort" data-sort="name"><?php echo e(__('Subtasks')); ?></th>
                                    <th scope="col" class="sort" data-sort="budget"><?php echo e(__('Tasks')); ?></th>
                                    <th scope="col" class="sort" data-sort="status"><?php echo e(__('Priority')); ?></th>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tasklyte\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>